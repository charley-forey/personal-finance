...
> **Source:** [https://plaid.com/docs/api/](https://plaid.com/docs/api/)
> **Section:** Overview
...
[#### API endpoints and webhooks](/docs/api/#api-endpoints-and-webhooks)

For documentation on specific API endpoints and webhooks, use the navigation menu or search.

[#### API access](/docs/api/#api-access)
...
[#### API protocols and headers](/docs/api/#api-protocols-and-headers)
...
[#### API status and incidents](/docs/api/#api-status-and-incidents)
...
[#### API field formats](/docs/api/#api-field-formats)[##### Strings](/docs/api/#strings)
...
[##### Numbers and money](/docs/api/#numbers-and-money)
...
[#### OpenAPI definition file](/docs/api/#openapi-definition-file)
...
[#### Postman collection](/docs/api/#postman-collection)
...
[#### Client libraries](/docs/api/#client-libraries)
