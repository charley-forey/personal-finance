...
> **Source:** [https://plaid.com/docs/api/link/](https://plaid.com/docs/api/link/)
> **Section:** Fundamentals
...
[### Endpoints](/docs/api/link/#endpoints)=\*=\*=\*=[#### `/link/token/create`](/docs/api/link/#linktokencreate)

[#### Create Link Token](/docs/api/link/#create-link-token)
...
If launching Link with CRA products, `cra_base_report` is required and must be included in the `products` array.
...
=\*=\*=\*=[#### `/link/token/get`](/docs/api/link/#linktokenget)

[#### Get Link Token](/docs/api/link/#get-link-token)
...
[### Webhooks](/docs/api/link/#webhooks)=\*=\*=\*=[#### `ITEM_ADD_RESULT`](/docs/api/link/#item_add_result)
...
=\*=\*=\*=[#### `SESSION_FINISHED`](/docs/api/link/#session_finished)
