...
> **Source:** [https://plaid.com/docs/api/products/investments/](https://plaid.com/docs/api/products/investments/)
> **Section:** Financial Insights
...
[### Endpoints](/docs/api/products/investments/#endpoints)=\*=\*=\*=[#### `/investments/holdings/get`](/docs/api/products/investments/#investmentsholdingsget)

[#### Get Investment holdings](/docs/api/products/investments/#get-investment-holdings)
...
[#### Get investment transactions](/docs/api/products/investments/#get-investment-transactions)
...
=\*=\*=\*=[#### `/investments/refresh`](/docs/api/products/investments/#investmentsrefresh)

[#### Refresh investment data](/docs/api/products/investments/#refresh-investment-data)
...
[### Webhooks](/docs/api/products/investments/#webhooks)

Updates are sent to indicate that new holdings or investment transactions are available.

=\*=\*=\*=[#### `HOLDINGS: DEFAULT_UPDATE`](/docs/api/products/investments/#holdings-default_update)
...
=\*=\*=\*=[#### `INVESTMENTS_TRANSACTIONS: DEFAULT_UPDATE`](/docs/api/products/investments/#investments_transactions-default_update)
...
=\*=\*=\*=[#### `INVESTMENTS_TRANSACTIONS: HISTORICAL_UPDATE`](/docs/api/products/investments/#investments_transactions-historical_update)
